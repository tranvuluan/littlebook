        ...
        <div class="hotline-phone-ring-wrap">
            ...
            <div class="hotline-bar tuychinh">
                <a href="tel:0868486575">
                    <span class="text-hotline">0868486575</span>
                </a>
            </div>
        </div>
        <!-- Cart -->
        <div class="cart">
            <div class="hotline-phone-ring">
                ...
                <div class="hotline-phone-ring-img-circle">
                    <a href="cart.php" class="pps-btn-img">
                        <i class="fa fa-shopping-cart" style="font-size: 16px; color: white;" aria-hidden="true"></i>
                        <div id="count" class="count bottom"> <?php (isset($_SESSION['cart']))? print count($_SESSION['cart']): print 0?>
                        </div>
                    </a>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 col-md-3">
                        ...
                        <ul class="footer-links">
                            ...
                            <li><i class="fa fa-phone"></i>(+84) 868486575</li>
                            <li><i class="fa fa-user-circle"></i>CEO & Founder: <a href="https://www.facebook.com/luan.luan23082001">@Little Stupid</a></li>
                            <li><iframe style="width: 200px; height: 120px; margin-top: 10px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3723.8902985331238!2d105.78692641424541!3d21.03707499287183!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ab36199716e1%3A0xf875e5d1636b181c!2zTmjDoCBTw6FjaCBOZ3V54buFbiBWxINuIEPhu6s!5e0!3m2!1svi!2s!4v1607339743873!5m2!1svi!2s" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe></li>
                        </ul>
                    </div>
                </div>
                <hr>
